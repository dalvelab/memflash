...
import {type Question} from 'entities/quiz/model';

type QuizCardCreateProps = {
	index: number;
	question: Question;
	onInputChange: (
...
export const QuizCardCreate: React.FC<QuizCardCreateProps> = ({
	question,
	index,
	onInputChange,
	onCardDelete,
	...
	>
		...
		<Grid mt={3} gridTemplateColumns='1fr 1fr' gap={5}>
			...
			<InputGroup
				...
				onChange={e => {
					onInputChange('answer', e.target.value, index);
				}}
			/>
		</Grid>
	</Box>
